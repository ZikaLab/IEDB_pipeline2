...
See the CD4_epitopes branch for a recent update and integrating the legacy Perl code within Python wrappers https://github.com/ZikaLab/IEDB_pipeline2/tree/CD4_epitopes and containerizing the workflow
